...
let products = [
  {
    id: 2,
    title: "Patrick Ta Blush",
    category: "Makeup",
    price: "45",
    imageUrl: "images/makeup/patricktablush.jpg",
  },
  {
    id: 6,
    title: "Laneige Lip Kit",
    category: "Skincare",
    price: "90",
    imageUrl: "images/skincare/laneigelipkit2.jpg",
  },

  {
    ...
    category: "Makeup",
    price: "30",
    imageUrl: "images/makeup/rarebeautyblush.jpg",
  },

  {
    id: 5,
    title: "Tower 28 Lip Gloss",
    category: "Makeup",
    price: "40",
    imageUrl: "images/makeup/tower28gloss.jpg",
  },
  {
    id: 12,
    title: "Kayali Vanilla Candy",
    category: "Fragrance",
    price: "190",
    imageUrl: "images/fragrance/kayali.jpg",
  },
  {
    id: 7,
    title: "Biossacce Radiance Set",
    category: "Skincare",
    price: "85",
    imageUrl: "images/skincare/biossanceset.jpg",
  },
  {
    id: 1,
    title: "Ilia Super Serum",
    category: "Makeup",
    price: "40",
    imageUrl: "images/makeup/iliasuperserum.jpg",
  },
  {
    id: 10,
    title: "YSL Libre",
    category: "Fragrance",
    price: "180",
    imageUrl: "images/fragrance/YSLlibre.jpg",
  },
  {
    id: 13,
    title: "Chanel Chance",
    category: "Fragrance",
    price: "170",
    imageUrl: "images/fragrance/chanelchance.jpg",
  },

  {
    id: 8,
    title: "Sol de Janeiro Body Oil",
    category: "Skincare",
    price: "68",
    imageUrl: "images/skincare/SoldeJaneirobodyoil.jpg",
  },
  {
    id: 4,
    title: "Rare Beauty Bronze Stick",
    category: "Makeup",
    price: "35",
    imageUrl: "images/makeup/rarebeautybronzestick.jpg",
  },

  {
    id: 9,
    title: "The Ordinary Acne Set",
    category: "Skincare",
    price: "50",
    imageUrl: "images/skincare/theordinaryacneset.jpg",
  },
  {
    id: 11,
    ...
    category: "Fragrance",
    price: "160",
    imageUrl: "images/fragrance/valentino.jpg",
  },
];
...
function decrementItem(title) {
  ...
  if (itemIndex > -1) {
    // Get item id before removing it
    let itemId = addedItem[itemIndex].id;
    ...
    // If the item is now completely removed from the cart
    let stillExists = addedItem.some((item) => item.id === itemId);
    if (!stillExists) {
      let addbtn = document.querySelector("#addbtn" + itemId);
      if (addbtn) {
        addbtn.classList.remove("btn-danger");
        addbtn.classList.add("btn-dark");
        addbtn.innerHTML = "Add to Cart";
  ...
  if (currentValue !== "") {
    if (searchbyval === "Name") {
      ...
      let result = products.filter((item) => {
        return (
          item.title.toLowerCase().substring(0, len) ==
      ...
      let result = products.filter((item) => {
        return (
          item.category.toLowerCase().substring(0, len) ==
          currentValue.toLowerCase()
        );
      });
